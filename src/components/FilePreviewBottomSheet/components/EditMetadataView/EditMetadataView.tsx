...
import {getFileNameFromAsset, logEvent} from '@utils/index';
import {editAudioMetadata, getAudioMetadata} from '@utils/audio';
...
const EditMetadataView: FC<{
  ...
  const showMoreButton = file.isRingtone ? null : (
    <Ripple
      onPress={() => {
        setShowMoreFields(true);
        logEvent('edit_metadata_show_more_fields');
      }}
      hitSlop={24}
