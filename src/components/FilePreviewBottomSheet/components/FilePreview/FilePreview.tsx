    ...
    return (
      <View style={styles.content}>
        ...
        <View style={styles.actions}>
          ...
          <ActionButton
            title={file.isRingtone ? 'Rename' : 'Edit Metadata'}
            icon="edit_square"
            onPress={() => {
              logEvent('edit_metadata_button_pressed');
          ...
          {file.isRingtone && (
            <ActionButton
              ...
              icon="info"
              onPress={() => {
                logEvent('set_as_ringtone_button_pressed');
